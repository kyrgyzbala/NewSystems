...
neighborhoods_path = os.path.join(gv.project_data_path, 'genes_and_flanks', 'win_10', 'merged')
...
def count_profiles_in_neighborhoods(neighborhoods_path, save_path, limit_to, combination_size):
    ...
    target_profiles = [l.strip() for l in open(os.path.join(gv.project_data_path, 'CDD', 'profile_ids_all.txt'))]
...
if __name__=='__main__':
    ...
    limit_to = 500
    combination_size = 2
    save_path = os.path.join(gv.project_data_path, 'genes_and_flanks/win_10/kmers/')
